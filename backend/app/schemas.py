...
fail-on-first-type-error semantics). The schemas below are used for
response serialization (`response_model=...`), which is where FastAPI/
Pydantic v2 add real value (automatic OpenAPI docs, response shape
guarantees).
"""
